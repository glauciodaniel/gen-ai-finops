  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          'relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected])]:text-accent-foreground [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected].day-range-end)]:rounded-r-md',
          props.mode === 'range'
      ...
      components={{
        // react-day-picker v9 renamed IconLeft/IconRight → Chevron with an
        // `orientation` prop, and Caption → MonthCaption.
        Chevron: ({ orientation }) =>
          orientation === 'left' ? (
